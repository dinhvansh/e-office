...
export default function TermsPage() {
  return <PolicyPage title="Terms of Service" version={policyMetadata.termsVersion} sections={[
    ...
    { heading: 'Service use', content: 'You may use an authorized E-Office workspace only for lawful document workflow, approval, and signing-related operations approved by your organization or workspace administrator.' },
    ...
    { heading: 'Trademarks', content: 'E-Office names, logos, and related marks are not licensed automatically. Use of marks must follow TRADEMARK.md or separate written permission.' },
    ...
    { heading: 'Governing law', content: `Governing law, venue, legal entity, and contracting party are ${policyMetadata.governingLaw}. These items must be confirmed by the maintainer before final publication.` },
  ]} />;
}
