...
export default function TermsPage() {
  return <PolicyPage title="Terms of Service" version={policyMetadata.termsVersion} sections={[
    ...
    { heading: 'Trademarks', content: 'FlowDocker™ and FlowDocker E-Office™ are trademarks of Nguyễn Đình Vân. Names, logos, and related marks are not licensed automatically. Use of marks must follow TRADEMARK.md or separate written permission.' },
