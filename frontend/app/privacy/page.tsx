...
export default function PrivacyPage() {
  return <PolicyPage title="Privacy Notice" version={policyMetadata.privacyVersion} sections={[
    ...
    { heading: 'Deployment roles', content: 'For self-hosted deployments, the organization operating the deployment controls workspace configuration, user access, retention, backup, security controls, and compliance decisions. The E-Office project does not operate those self-hosted environments.' },
    { heading: 'Data processed', content: 'Depending on configuration, E-Office may process account details, workspace and tenant details, roles and permissions, uploaded documents, signature and approval workflow data, audit events, email delivery metadata, object-storage metadata, and technical logs.' },
    ...
    { heading: 'Contact', content: `Support contact: ${policyMetadata.supportEmail}. Commercial/legal entity and privacy contact: ${policyMetadata.legalEntity}. These maintainer-owned values must be confirmed before final publication.` },
  ]} />;
}
