...
type Attachment = { id: number; file_name: string; file_size?: string | null; status?: string; withdraw_reason?: string | null };
type DiscussionComment = { id: number; body: string; created_at: string; deleted_at?: string | null; edited_at?: string | null; user?: { id: number; full_name?: string | null; email?: string | null } | null; attachments?: Attachment[] };
