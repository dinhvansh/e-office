...
const distDir = '.next-ux005';
await rm(distDir, { recursive: true, force: true });
const child = spawn(process.execPath, ['./node_modules/next/dist/bin/next', 'dev', '-p', '3019'], { env: { ...process.env, NEXT_DIST_DIR: distDir, NEXT_PUBLIC_API_BASE_URL: 'http://127.0.0.1:4010/api/v1', PORT: '3019' }, stdio: 'inherit' });
