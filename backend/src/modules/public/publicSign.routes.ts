...
import { publicSendOtpIpLimiter, publicSendOtpLimiter, publicVerifyOtpLimiter, strictLimiter } from '../../middleware/rate-limiter';
...
publicSignRouter.post('/:token/send-otp', publicSendOtpIpLimiter, publicSendOtpLimiter, asyncHandler(publicSignController.sendOtp));
