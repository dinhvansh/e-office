...
| External organization contact identity | PASS (read-after-create UI) | Not run | PASS (Admin) | Real UAT API/browser lifecycle rejects duplicate code and contact email within the tenant; normal-user and cross-tenant negative cases remain outstanding. |
